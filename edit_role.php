			                  	...
			                  	<div class="form-group bmd-form-group">
			                     	<div class="form-check">
									  <label class="form-check-label">
									    <input class="form-check-input" type="checkbox" name="code[]" value="A01" <?php if(in_array("A01",$section)) { ?> checked="checked" <?php } ?> > Stcok Update
									...
									<div class="form-check">
									  <label class="form-check-label">
									    <input class="form-check-input" type="checkbox" name="code[]" value="A04" <?php if(in_array("A04",$section)) { ?> checked="checked" <?php } ?> > Expense
									    <span class="form-check-sign">
									      <span class="check"></span>
									    </span>
									  </label>
									...
									<div class="form-check">
									  <label class="form-check-label">
									    <input class="form-check-input" type="checkbox" name="code[]" value="A05" <?php if(in_array("A05",$section)) { ?> checked="checked" <?php } ?> >Add Fuel
									    <span class="form-check-sign">
									      <span class="check"></span>
									    </span>
									  </label>
									...
									<div class="form-check">
									  <label class="form-check-label">
									    <input class="form-check-input" type="checkbox" name="code[]" value="A06" <?php if(in_array("A06",$section)) { ?> checked="checked" <?php } ?> > Sales
									    <span class="form-check-sign">
									      <span class="check"></span>
									    </span>
									  </label>
